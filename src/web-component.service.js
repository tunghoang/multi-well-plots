 ...
 * @name customElement
 */
angular.module(moduleName, ['conta.assert']);
 ...
 */
angular.module(moduleName).factory(moduleName, ['$injector', function ($injector) {
    ...
    var prototype = {
      ...
      connectedCallback: {
        ...
        value: function () {
          ...
          var componentElementWrapper = self;
          ...
          if (self.innerHTML) {
            ...
            self.componentElement[0].innerHTML = self.innerHTML;
          }
          ...
          if (events) {
            ...
            _.forEach(events, function (event, eventName) {
              self.$scope.vm[eventName] = function (...args) {
                self.dispatchEvent(new CustomEvent(eventName, { detail: args }));
              };

              self.componentElement.attr(_.kebabCase(eventName), 'vm.' + eventName);
          ...
          $timeout(function () {
            componentElementWrapper.style.visibility = null;
          });
        },
      },
  ...
  function decode(options) {
    ...
    return function (bindingName) {
      ...
      return {
        ...
        get: function () {
          return this.$scope.vm[bindingName];
        },
      };
    };
  }
